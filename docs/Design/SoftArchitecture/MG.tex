...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{/Users/mohamad/Desktop/git/cas741/docs/Presentations/D0_ProofOfConceptDemo/architecture_diagram.png}
...
\multirow{7}{0.3\textwidth}{Behaviour-Hiding} & \mref{m2}\\
& \mref{m3}\\
& \mref{m4}\\
& \mref{m5}\\
& \mref{m6}\\
