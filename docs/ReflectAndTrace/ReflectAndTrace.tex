...
Reclassified M4, M5, M8 as \emph{Behaviour-Hiding} in the Module Hierarchy
table. During the final pass, Section~6 of the MG was restructured so that
its subsection headers (Hardware-Hiding / Behaviour-Hiding / Software
Decision) match the table, and the now-empty Software Decision entry is
marked with~``--''.\\
